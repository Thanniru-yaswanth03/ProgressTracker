    ...
    <Card className="p-5 border-slate-200 dark:border-slate-800/80 flex flex-col justify-between space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/60 pb-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link
            href="/habits"
            className="text-xs text-amber-600 dark:text-amber-400 hover:text-amber-500 dark:hover:text-amber-300 font-semibold flex items-center gap-0.5 transition-colors"
          >
            <span>View All</span>
                ...
                <div className="flex items-center gap-2.5 min-w-0 flex-1">
                  <button
                    ...
                    className={cn(
                      ...
                      isDoneToday
                        ? "bg-amber-500 border-amber-400 text-white dark:text-slate-950 font-bold shadow-md shadow-amber-500/20"
                        : "border-slate-300 dark:border-slate-700 hover:border-amber-400 bg-slate-50 dark:bg-slate-800/60"
                    )}
