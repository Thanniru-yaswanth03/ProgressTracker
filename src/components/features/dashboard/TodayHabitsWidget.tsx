            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isDoneToday
                    ? "bg-amber-500/10 border-amber-500/25 text-[var(--foreground)]"
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0 flex-1">
                  <button
                    ...
                    className={cn(
                      ...
                      isDoneToday
                        ? "bg-amber-500 border-amber-400 text-white font-bold animate-check-pop shadow-xs"
                        : "border-[var(--border-strong)] hover:border-amber-400 bg-[var(--surface-sub)]"
                    )}
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {habit.section && (
                      <span
                        ...
                        style={{ color: habit.section.color || "var(--primary)" }}
                      >
                        {habit.section.name}
                      </span>
                    )}
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  {habit.streak.longestStreak > 0 && (
                    <span
                      className="text-[10px] text-[var(--muted-foreground)] hidden sm:inline font-mono"
