    ...
    <Card className="p-5 border-slate-800/80 flex flex-col justify-between space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-slate-800/60 pb-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link
            href="/tasks"
            className="text-xs text-indigo-400 hover:text-indigo-300 font-medium flex items-center gap-0.5 transition-colors"
          >
            <span>View All</span>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isCompleted
                        ...
                        : "border-slate-700 hover:border-sky-400 bg-slate-800/60"
                    )}
                  >
