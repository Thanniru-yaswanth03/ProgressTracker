...
- **AI Intelligence**: [OpenRouter API](https://openrouter.ai/) (Configured with `openrouter/free`, compatible with Claude Sonnet, GPT-4o, DeepSeek)
...
Run the comprehensive automated verification suite covering multi-tenant isolation, calculations, and live AI integration:
...
3. **Configure Environment Variables** in the Vercel dashboard:
   ...
   - `OPENROUTER_MODEL`: `openrouter/free` (or your preferred OpenRouter model).
